...
from util.data_loader import get_loader  # Assuming you have a custom data loader
...
def main():
    ...
    parser.add_argument('--mode', default='inter', help='training mode, must be in [inter, intra]')
    ...
    parser.add_argument('--train_iter', default=1000, type=int, help='num of iters in training')
    parser.add_argument('--val_iter', default=200, type=int, help='num of iters in validation')
    parser.add_argument('--test_iter', default=600, type=int, help='num of iters in testing')
    parser.add_argument('--val_step', default=50, type=int, help='val after training how many iters')
    parser.add_argument('--model', default='proto', help='model name, must be proto, nnshot, or structshot')
    ...
    pretrain_ckpt = opt.pretrain_ckpt or 'bert-base-multilingual-cased'  # Changed to mBERT
